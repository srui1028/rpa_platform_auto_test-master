...
path = TEST_DATA_PATH + r"/total_task_by_type_curdate.yml"
...
@allure.title("{detail}")
def test_task_count_by_type_curdate(set_base_url, set_user_header, rpa_platform_token,zbody, vzbody, dbody, detail):
    print("\n================================" + detail + "==================================")
...
if __name__ == '__main__':
    pytest.main(["-s","test_task_num_by_type_curdate.py"])
